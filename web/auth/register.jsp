...
<html>
    ...
    <body>
        <div class="flex flex-col justify-center items-center h-screen">
            <h1 class="text-4xl font-bold text-indigo-500">Register</h1>
            ...
            <form class="mt-6 w-1/3" method="post" action="${pageContext.request.contextPath}/register">
                ...
                <button type="submit" class="mt-6 bg-indigo-500 text-white py-2 w-full rounded cursor-pointer hover:bg-indigo-600 transition-colors">Register</button>
            </form>
        </div>
    </body>
</html>
