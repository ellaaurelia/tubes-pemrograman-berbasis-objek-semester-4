...
<html>
    ...
    <body class="bg-gray-100 flex items-center justify-center min-h-screen">
        ...
        <div class="text-center p-6 bg-white rounded-2xl shadow-lg w-full max-w-md">
            <h1 class="text-4xl font-bold text-indigo-500 mb-4">TaskTrack</h1>
            <p class="text-gray-600 mb-6 text-lg italic">Track your tasks with TaskTrack</p>

            <div class="space-x-4">
                <a href="auth/login.jsp" class="bg-indigo-500 text-white px-4 py-2 rounded hover:bg-indigo-600 transition">Login</a>
